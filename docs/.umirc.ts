...
const productPath = `/formily-antd-materials@${version}/build/docs/`;
...
export default defineConfig({
  ...
  chainWebpack(memo) {
    ...
    memo.resolve.alias.set('formily-antd-materials', join(__dirname, '../src'));
  },
  ...
  alias: {
    ...
    'formily-antd-materials': join(__dirname, '../src'),
  },
  apiParser: {
    propFilter: (prop) => {
